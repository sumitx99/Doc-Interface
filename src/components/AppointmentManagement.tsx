...
import { Plus, Search, Edit, Trash2, Calendar, Clock, User, CheckCircle, XCircle } from 'lucide-react';
...
const AppointmentManagement: React.FC = () => {
  ...
  const handleStatusChange = (id: string, status: Appointment['status']) => {
    ...
    if (appointment) {
      const updatedAppointment = { ...appointment, status, updatedAt: new Date().toISOString() };
      dataService.saveAppointment(updatedAppointment);
      setAppointments(dataService.getAppointments());
    }
  };
